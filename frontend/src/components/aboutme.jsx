...
function Aboutme(){
    ...
    const aboutme =  `Hey, I’m Arjun Verma, a sophomore at Guru Ghasidas University, majoring in Information Technology. I’ve been hooked on tech since middle school, where I dabbled in cybersecurity and robotics. These days, I’m exploring blockchains and Web3 while keeping my problem-solving game sharp—whether it’s cracking LeetCode questions or brainstorming over a challenging project. I also enjoy writing technical blogs to share my thoughts and ideas (check out my canvas below). If you’ve got a cool idea you think I can contribute to, drop me a message! Bonus points if you’re looking for a coding buddy—we could brainstorm, build, and debug something awesome together.

      On the tech side, I’m fluent in C++, JavaScript, TypeScript, and Python, and I’ve recently started diving into Rust to write smart contracts. I’ve got hands-on experience in web development, having built and deployed some exciting projects. My go-to stack is MERN, but I’m also familiar with Django.`
